...
const VehicleAssignForm = () => {
  ...
  const [bid, setBuyerID] = useState();
  const [bname, setBuyerName] = useState();
  ...
  return (
    <div>
        ...
        >
            ...
            <Form.Select aria-label="Vehicle No" value={vno} onChange={(e) => setVehicleNo(e.target.value)}>
              <option selected disabled hidden>Vehicle No</option>
